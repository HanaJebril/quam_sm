...
# def morph_op(mask, op="dilate", kernel_size=3):
#     """
#     Morphological operation on binary mask.
#     mask: shape [1,H,W] (LongTensor or FloatTensor with 0/1 values)
#     """
#     mask = mask.float().unsqueeze(0)  # shape [B=1,1,H,W]
...
#     return out.squeeze(0).long()  # back to [1,H,W] with 0/1 values
