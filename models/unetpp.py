...
class UNetpp(nn.Module):
    ...
    def __init__(self, in_channels, n_classes, channels=64, is_deconv=True, is_batchnorm=True,is_ds=True,drop = 0.3):
        ...
        # downsampling
        self.conv00 = unetConv2(self.in_channels, self.channels, self.is_batchnorm,self.drop )
        self.maxpool0 = nn.MaxPool2d(kernel_size=2)
        self.conv10 = unetConv2(self.channels,self.channels, self.is_batchnorm, self.drop )
        self.maxpool1 = nn.MaxPool2d(kernel_size=2)
        self.conv20 = unetConv2(self.channels, self.channels, self.is_batchnorm, self.drop )
        self.maxpool2 = nn.MaxPool2d(kernel_size=2)
        self.conv30 = unetConv2(self.channels,self.channels, self.is_batchnorm, self.drop )
        self.maxpool3 = nn.MaxPool2d(kernel_size=2)
        self.conv40 = unetConv2(self.channels, self.channels, self.is_batchnorm, self.drop )
