...
from models.nn.cross_conv import CrossConv2d
from models.nn.init import reset_conv2d_parameters
from models.nn.vmap import Vmap, vmap
...
class TysegXC(nn.Module):
    ...
    def __post_init__(self,):
        super().__init__()
#         self.out_channels = out_channels  # 3 outputs to compare to SAM
